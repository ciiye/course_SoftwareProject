...
INSERT INTO `admin_role`(`role_id`, `role_parent_id`, `role_name`, `role_desc`, `role_status`, `role_type`)
VALUES (1,0,'超级管理员','拥有所有权限',0,1);
...
INSERT INTO `admin_role_user`(`role_user_id`, `role_user_role_id`, `role_user_user_id`) VALUES (1,1,1);
